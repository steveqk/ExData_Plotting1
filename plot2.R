...
plot(data_subset$Global_active_power~as.POSIXct(paste(data_subset$Date, data_subset$Time), format="%Y-%m-%d %H:%M:%S"), type = 'l', ylab = 'Global Active Power (Kilowatts)', xlab = '')
dev.off()
